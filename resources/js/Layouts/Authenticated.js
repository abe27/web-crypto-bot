...
const navigation = [
  ...
  { name: 'ศูนย์การช่วยเหลือ', href: route('helpcenter'), ref: 'helpcenter' },
]
const userNavigation = [
  { name: 'ข้อมูลส่วนตัว', href: route('profile'), admin: false },
  { name: 'ตั้งค่าระบบ', href: '#', admin: true },
  { name: 'ออกจากระบบ', href: route('logout'), admin: false },
]
                    ...
                    <Disclosure.Button
                      ...
                      className={classNames(
                        item.current
                          ...
                          : 'text-gray-300 hover:bg-gray-700 hover:text-white',
                        'z-40 block px-3 py-2 rounded-md text-base font-medium',
                      )}
                      aria-current={item.current ? 'page' : undefined}
                    >
                      {item.name}
